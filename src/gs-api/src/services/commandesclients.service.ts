...
class CommandesclientsService extends __BaseService {
  static readonly findAllPath = '/api/Command/all';
  static readonly savePath = '/api/Command/create';
  static readonly deleteArticlePath = '/gestiondestock/v1/commandesclients/delete/article/{idCommande}/{idLigneCommande}';
  static readonly deletePath = '/api/Command/delete/{idCommandeClient}';
  static readonly findByCodePath = '/gestiondestock/v1/commandesclients/filter/{codeCommandeClient}';
  static readonly findAllLignesCommandesClientByCommandeClientIdPath = '/api/ligneCommand/{idCommande}';
  static readonly findAllClientCommandesClientByClientId =  '/api/Client/{idClient}';
  ...
  deleteResponse(idCommandeClient: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/Command/delete/${idCommandeClient}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteLigneResponse(idLigneCommande: number): __Observable<__StrictHttpResponse<null>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/ligneCommand/delete/${idLigneCommande}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteLigne(idLigne: number): __Observable<null> {
    return this.deleteLigneResponse(idLigne).pipe(
      __map(_r => _r.body as null)
    );
  }
  ...
  findAllLignesCommandesClientByCommandeClientIdResponse(idCommande: number): __Observable<__StrictHttpResponse<Array<LigneCommandeClientDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/ligneCommand/${idCommande}`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return successful operation
   */
  findAllClientCommandesClientByClientIdResponseResponse(idCommande: string): __Observable<__StrictHttpResponse<Array<LigneCommandeClientDto>>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/client/${idCommande}`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return successful operation
   */
  findAllCommandesbyidEntrepriseResponse(idEntreprise: string): __Observable<__StrictHttpResponse<Array<CommandeClientDto>>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/command/idEntreprise/${idEntreprise}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findAllCommandesbyidEntreprise(idEntreprise: string): __Observable<Array<CommandeClientDto>> {
    return this.findAllCommandesbyidEntrepriseResponse(idEntreprise).pipe(
  ...
  findAllClientCommandesClientByClientId(idClient: string): __Observable<Array<LigneCommandeClientDto>> {
    return this.findAllClientCommandesClientByClientIdResponseResponse(idClient).pipe(
      __map(_r => _r.body as Array<LigneCommandeClientDto>)
    );
  }
  ...
  findByIdResponse(idCommandeClient: number): __Observable<__StrictHttpResponse<CommandeClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/Command/${idCommandeClient}`,
      __body,
      {
        headers: __headers,
        params: __params,
