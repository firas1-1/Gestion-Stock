...
class FournisseurService extends __BaseService {
  static readonly findAllPath = '/api/fournisseur/all';
  static readonly savePath = '/api/fournisseur/create';
  static readonly deletePath = '/api/fournisseur/delete/{idFournisseur}';
  static readonly findByIdPath = '/api/fournisseur/{idFournisseur}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<FournisseurDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/fournisseur/all`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  saveResponse(body?: FournisseurDto): __Observable<__StrictHttpResponse<FournisseurDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/api/fournisseur/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idFournisseur: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/fournisseur/delete/${idFournisseur}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(idFournisseur: number): __Observable<__StrictHttpResponse<FournisseurDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/fournisseur/${idFournisseur}`,
      __body,
      {
        headers: __headers,
        params: __params,
