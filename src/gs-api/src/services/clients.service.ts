...
class ClientsService extends __BaseService {
  static readonly findAllPath = '/api/client/all';
  static readonly savePath = '/api/client/create';
  static readonly deletePath = '/api/client/delete/{idClient}';
  static readonly findByIdPath = '/api/client/{idClient}';
  ...
  saveResponse(body?: ClientDto): __Observable<__StrictHttpResponse<ClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/api/client/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idClient: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/client/delete/${idClient}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(idClient: number): __Observable<__StrictHttpResponse<ClientDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/client/${idClient}`,
      __body,
      {
        headers: __headers,
        params: __params,
