...
class ArticlesService extends __BaseService {
  static readonly findAllPath = '/api/article/all';
  static readonly savePath = '/api/article/create';
  static readonly deletePath = '/api/article/delete/{idArticle}';
  ...
  static readonly findByIdPath = '/api/article/{idArticle}';
  ...
  findAllArticlesInMvtResponse(code: string): __Observable<__StrictHttpResponse<Array<ArticleDto>>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/article/all/${code}`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return La liste des article / Une liste vide
   */
  findAllArticlesInMvt(code:string): __Observable<Array<ArticleDto>> {
    return this.findAllArticlesInMvtResponse(code).pipe(
      __map(_r => _r.body as Array<ArticleDto>)
    );
  }
  ...
  saveResponse(body?: ArticleDto): __Observable<__StrictHttpResponse<ArticleDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/api/article/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idArticle: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/api/article/delete/${idArticle}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(idArticle: number): __Observable<__StrictHttpResponse<ArticleDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/api/article/${idArticle}`,
      __body,
      {
        headers: __headers,
        params: __params,
