...
import { ModifierCommandeComponent } from './pages/modifier-commande/modifier-commande.component';
import { ModifierCommandComponent } from './composants/modifier-command/modifier-command.component';
import { ModifierCommandArticleComponent } from './composants/modifier-command-article/modifier-command-article.component';
...
@NgModule({
  declarations: [
    ...
    ModifierCommandComponent,
    ModifierCommandArticleComponent,
    FactureComponent,
    FooterComponent,
    ArgentsComponent,
    AlerteComponent,
