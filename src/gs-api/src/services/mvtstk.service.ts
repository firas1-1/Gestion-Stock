...
class MvtstkService extends __BaseService {
   ...
   * @return successful operation
   */
  mvtStkArticleResponse(idArticle: string): __Observable<__StrictHttpResponse<Array<MvtStkDto>>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * @return successful operation
   */
  mvtStkArticle(idArticle: string): __Observable<Array<MvtStkDto>> {
